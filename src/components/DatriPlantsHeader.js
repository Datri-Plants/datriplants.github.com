    ...
    return (
        <div>
            ...
            >
                ...
                <header className={`${styles["u-clearfix"]} ${styles["u-header"]} ${styles["u-sticky"]} ${styles["u-header"]}`} id="sec-1a48">
                <a href="/DatriplantsHeader/#615303896" className={`${styles["u-image"]} ${styles["u-logo"]} ${styles["u-image-1"]}`} data-image-width="528"
                data-image-height="472" data-page-id="615303896" data-animation-name="customAnimationIn" data-animation-duration="1000" data-animation-direction="" title="Home">
